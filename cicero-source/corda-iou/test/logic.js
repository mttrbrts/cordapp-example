...
describe('Logic', () => {
    ...
    describe('#IOUContract', async function() {

        it('should succeed for a positive IOU value', async function() {
            const request = {};
            request.$class = 'org.accordproject.sample.corda.iou.IOURequest';
            request.value = 1;
        ...
        it('should reject a negative IOU', async function() {
            const request = {};
            request.$class = 'org.accordproject.sample.corda.iou.IOURequest';
            request.value = -1;
