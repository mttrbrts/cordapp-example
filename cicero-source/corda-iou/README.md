...
# Accord Protocol Template: corda-iou
...
```
cicero parse --template ./corda-iou/ --dsl ./corda-iou/sample.txt
...
data.json:
{
   "$class": "org.accordproject.sample.corda.iou.MyRequest",
   "input": "World"
}
```

```
cicero execute --template ./corda-iou/ --dsl ./corda-iou/sample.txt --data ./corda-iou/data.json 
```
...
```
{
   ...
   "request":{
      "$class":"org.accordproject.sample.corda.iou.Request",
      "input":"World"
   },
   "response":{
      "$class":"org.accordproject.sample.corda.iou.Response",
